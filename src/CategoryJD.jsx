...
export default class CategoryJD extends PureComponent {
  static propTypes = {
  ...
  render() {
    const { className, prefixCls, dataSource, link, onChange, alias } = this.props;
    const { selectedMenu } = this.state;
    const { title, path, image, children } = {
      title: 'title',
      path: 'path',
      image: 'image',
      children: 'children',
